...
Loading in relationship file for sheriff's agencies that particpated in the 287(g) program. Here's a slice of what the data looks like:
...
# counting up Sheriff's Office Agencies in data set post-2018
...
round(mean(summary_agency_type_annual6$join_change, na.rm=T),2)
# +3
